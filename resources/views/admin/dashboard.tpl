    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 bg-gray-900 p-6 overflow-y-auto">
            ...
            <div class="mt-6 bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <p>Aktueller Lizenzstatus: <span class="font-bold">{$licenseStatus}</span></p>
                <p>Lizenzen laufen am: <span class="font-bold">{$licenseExpiry}</span></p>
                <p>Anzahl aktiver Lizenzen: <span class="font-bold">{$activeLicenses}</span></p>
            </div>
